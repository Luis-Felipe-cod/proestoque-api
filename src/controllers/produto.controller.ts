...
export class ProdutoController {
    ...
    try {
      ...
      const produtos = await prisma.produto.findMany({
        where: {
          ...
          ...(apenasAlerta === "true" && { quantidade: { lt: prisma.produto.fields.quantidadeMinima } }),
        },
  ...
  async criar(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!nome || !categoriaId || preco === undefined) throw new AppError("Campos obrigatórios: nome, categoriaId, preco");
